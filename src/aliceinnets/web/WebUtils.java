...
public class WebUtils {
	...
	public final static void saveUrl(String url, String savePath) throws IOException {
		saveUrl(url, savePath, bufferSize, timeout, userAgent);
	}
	
	
	public final static void saveUrl(String url, String savePath, int bufferSize, int timeout, String userAgent) throws IOException {
